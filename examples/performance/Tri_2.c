...
//gcc-13 ./examples/performance/Tri_2.c -g -o main  -lGL -lcglm -lSDL3 -lm

// Instanced drawing - Vertex + Fragment shaders.
// One draw calls - for wireframes and for solid
// EBO allocated only once before all drawcalls
// 9 vertices
// 7 triangles
// Elapsed time: 2.11 ms
...
"  float dx; \n"
"  float dy = iPos.y; \n"
"  if(gl_VertexID > 2 && iPos.z > 0.0){\n"
"    dx = -1000.0;\n"
"  } else if(gl_VertexID < 3 && iPos.z == 0.0){\n"
"    dx = -1000.0;\n"
"  } else {\n"
"    dx = iPos.x;\n" 
"  } \n"
...
int main() {
    ...
    //  x           y                               
       ...
       -size*0.5,  -size*0.5,  //             
        ...
        0.0f,       size*0.5,  //         7     8    
       -size*0.5,  -size*0.5,  //                      
        size*0.5,  -size*0.5,  //    1;4           2;5 
        
        0.0f,                   size*0.5 - thickness,
       -size*0.5 + thickness,  -size*0.5 + thickness,
        size*0.5 - thickness,  -size*0.5 + thickness,
    };
    
    unsigned int indices[] = {
        3, 6, 5, 6, 5, 8, 5, 8, 4, 4, 7, 8, 4, 7, 6, 3, 6, 4,
        0, 1, 2
    };
    ...
    do {
        ...
        glDrawElementsInstanced(GL_TRIANGLES, 21, GL_UNSIGNED_INT, 0, n);
